...
- `RUv1-Всё, кроме РФ`, чтобы ходить на все зарубежные ресурсы через прокси. Это удобно для посещения ресурсов, которые блокируют пользователей из РФ.
- `RUv1-Заблокированное`, чтобы ходить только на заблокированные в РФ ресурсы через прокси. Это обходит только блокировки РКН.
3. Проверьте работу посещением рутрекера [https://rutracker.org/](https://rutracker.org/)

<img src="v2rayn-routing.png" alt="screenshot" width="75%" height="75%">
