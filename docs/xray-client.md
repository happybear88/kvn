...
Набор правил слегка отличается от того, что используется на Android. Подразумевается использование набора гео-файлов, которое задано в программе по умолчанию - от [LoyalSoldier](https://github.com/Loyalsoldier/v2ray-rules-dat).
