...
2. Меню ≡ - **Инструменты** - **Бэкап** - **Импортировать из файла** - выберите сохраненный файл и согласитесь на перезапись настроек.

<img src="nekobox-import.png" alt="screenshot">

### Управление состоянием подключения Nekobox
Когда настроены конкретные приложения, можно активировать подключение и не отключать. Nekobox добавляет постоянное уведомление, а также свою плитку в шторку. Нужно перейти в настройки шторки и перетащить плитку с котом 😺 в начало списка. 
...
**Примечание**. В предоставленной вам конфигурации уже может быть заложен список приложений.
...
3. Меню ≡ - **Настройки** - **Маршруты** - найдите правило **Избранные приложения - прокси** в конце списка и добавьте в него свои приложения. Если такого правила нет, создайте его и поместите внизу перед правилом **Все остальное - прокси**. Внесите свои приложения в правило и убедитесь, что внизу правило указано **outbound: прокси**.
...
### Активация подключения к серверу (Firefox)
