...
3. Нажмите ✔️, на следующем экране нажмите ↩️, чтобы добавить серверы из подписки.
